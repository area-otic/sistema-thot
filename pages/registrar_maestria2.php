                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select select2" name="maestria-pais" placeholder="Ej: Perú" required>
                                <option value="">Seleccionar...</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="maestria-ciudad-universidad" value="<?= htmlspecialchars($ciudad_universidad) ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" name="maestria-fecha-admision" value="<?= htmlspecialchars($fecha_admision) ?>" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Idioma*</label>
                            <select class="form-select" name="maestria-idioma" required>
                                <option value="">Seleccionar...</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select" name="maestria-precio-moneda" style="max-width: 120px;" >
                                    <option value="">Moneda</option>
                                    <option value="USD" <?= ($precio_moneda == 'USD') ? 'selected' : '' ?>>USD</option>
                                    <option value="EUR" <?= ($precio_moneda == 'EUR') ? 'selected' : '' ?>>EUR</option>
                                    <option value="PEN" <?= ($precio_moneda == 'PEN') ? 'selected' : '' ?>>PEN</option>
                                </select>
                            </div>
                        </div>
