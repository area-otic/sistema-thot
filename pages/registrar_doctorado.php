...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $id_num = trim($_POST['doctorado-idnum']);
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="doctorado-fecha-admision" value="<?= htmlspecialchars($fecha_admision) ?>" >
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group has-validation"> <!-- Agregado has-validation para validación -->
                                ...
                                <input type="number" class="form-control" id="precio-input" name="doctorado-precio-monto" 
                                    value="<?= htmlspecialchars($precio_monto) ?>"
                                    min="0"  step="0.01" placeholder="0.00"  required aria-describedby="moneda-help">
                                
                                <select class="form-select" id="select-moneda" name="doctorado-precio-moneda" required aria-label="Seleccione moneda">
