...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    ?>
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Maestrías/</span> Registros</h4>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
              <a class="btn btn-secondary" href='importar_pro.php?origen=maestria'>Importar</a>
